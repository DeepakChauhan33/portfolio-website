...
const Skill = () => {
  ...
  return (
    <section id='skill' className={`min-h-120 p-5 px-4 py-10  sm:px-6 sm:py-14  md:px-8 md:py-16  lg:px-10 lg:py-20 border-amber-500 gap-x-8 ${theme === "dark" ? "bg-gradient-to-br from-black via-slate-900 to-zinc-800 text-white" : "bg-gradient-to-br from-white via-stone-50 to-neutral-200"}`}>
